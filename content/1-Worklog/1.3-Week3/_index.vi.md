...
- Nắm các thành phần mạng AWS cần dùng cho project.
- Thiết kế mạng và cơ sở dữ liệu phù hợp với kiến trúc dự kiến.
...
- Em hiểu luồng mạng cơ bản trong VPC và sự khác nhau giữa public/private subnet.
- Em hoàn thành sơ đồ mạng phù hợp với kiến trúc production dự kiến.
- Database schema đã sẵn sàng để phát triển các chức năng.
